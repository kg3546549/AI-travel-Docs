...
import { A as AstroError, U as UnknownContentCollectionError, c as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, b as renderTemplate, p as renderUniqueStylesheet, q as renderScriptElement, t as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_Dl0Lptuc.mjs';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CSsoWb5G.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/AI-travel-Docs", "DEV": false, "MODE": "production", "PROD": true, "SITE": undefined, "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_EDNUdGjJ.mjs').then(n => n._);
...
const starlightConfig = {"description":"조건 몇 가지만 입력하면, AI가 완성된 여행 일정을 만들어준다","tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"서비스 개요","translations":{},"link":"/01-overview","attrs":{}},{"label":"프로덕트 & UX","translations":{},"link":"/02-product","attrs":{}},{"label":"디자인 시스템","translations":{},"link":"/03-design","attrs":{}},{"label":"AI 설계","translations":{},"link":"/04-ai","attrs":{}},{"label":"데이터베이스","translations":{},"link":"/05-database","attrs":{}},{"label":"웹 프론트엔드","translations":{},"link":"/06-web","attrs":{}},{"label":"Flutter 앱","translations":{},"link":"/07-app","attrs":{}},{"label":"인프라 & 배포","translations":{},"link":"/08-infra","attrs":{}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"ko":"AI 여행 플래너"},"isMultilingual":false,"defaultLocale":{"label":"한국어","lang":"ko","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///Users/kg/Desktop/dev/travel/AI-travel-Docs/","srcDir":"file:///Users/kg/Desktop/dev/travel/AI-travel-Docs/src/","trailingSlash":"ignore"};
